...
class QuarterlyStoreSummary extends AggregationModel
{
    ...
    protected $fillable = [
        ...
        // Growth
        'sales_vs_prior_quarter',
        'sales_growth_percent',
        'sales_vs_same_quarter_prior_year',
        'yoy_growth_percent',
    ...
    protected $casts = [
        ...
        'sales_vs_prior_quarter' => 'decimal:2',
        'sales_growth_percent' => 'decimal:2',
        'sales_vs_same_quarter_prior_year' => 'decimal:2',
        'yoy_growth_percent' => 'decimal:2',
