...
class ThirdPartyMarketplaceOrdersHot extends OperationalModel
{
    protected $table = 'third_party_marketplace_orders_hot';
    ...
    {
        return ($this->doordash_order_total_Marketplace ?? 0) +
               ($this->uberEats_order_total_Marketplace ?? 0) +
               ($this->grubhub_order_total_Marketplace ?? 0);
    }
}
