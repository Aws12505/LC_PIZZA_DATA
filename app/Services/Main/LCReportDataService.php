...
class LCReportDataService
{
    ...
    protected array $processorMap = [
        ...
        'finance-data' => FinanceDataProcessor::class,
        'final-summaries' => FinalSummariesProcessor::class,
        'hourly-sales' => HourlySalesProcessor::class,
        'hour-hnr' => HourHNRTransactionsProcessor::class,
        'store-hnr' => StoreHNRTransactionsProcessor::class,
        'channel-data' => ChannelDataProcessor::class,
        'bread-boost' => BreadBoostProcessor::class,
        'online-discount' => OnlineDiscountProgramProcessor::class,
        'delivery-order-summary' => DeliveryOrderSummaryProcessor::class,
        'third-party' => ThirdPartyMarketplaceOrdersProcessor::class,
