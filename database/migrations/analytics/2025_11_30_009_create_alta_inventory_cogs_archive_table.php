...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('alta_inventory_cogs_archive', function (Blueprint $table) {
            ...
            $table->unique(['franchise_store', 'business_date', 'count_period', 'inventory_category'], 'inv_cogs_unique_arch');
        });

        // Add monthly partitioning with compression
        $this->addMonthlyPartitions('alta_inventory_cogs_archive');
    }
    ...
    {
        Schema::connection($this->connection)->dropIfExists('alta_inventory_cogs_archive');
    }
};
