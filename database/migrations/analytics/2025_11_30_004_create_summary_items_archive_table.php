...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('summary_items_archive', function (Blueprint $table) {
            ...
            $table->unique(['franchise_store', 'business_date', 'menu_item_name', 'item_id'], 'unique_summary_items_archive');
        });

        // Add monthly partitioning with compression
        $this->addMonthlyPartitions('summary_items_archive');
    }
    ...
    {
        Schema::connection($this->connection)->dropIfExists('summary_items_archive');
    }
};
