...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('finance_data_archive', function (Blueprint $table) {
            ...
            $table->unique(['franchise_store', 'business_date'], 'unique_finance_data_archive');
        });

        // Add monthly partitioning with compression
        $this->addMonthlyPartitions('finance_data_archive');
    }
    ...
    {
        Schema::connection($this->connection)->dropIfExists('finance_data_archive');
    }
};
