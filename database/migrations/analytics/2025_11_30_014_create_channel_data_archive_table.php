...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('channel_data_archive', function (Blueprint $table) {
        ...
        $this->addMonthlyPartitions('channel_data_archive');
    }
    ...
    {
        Schema::connection($this->connection)->dropIfExists('channel_data_archive');
    }
};
