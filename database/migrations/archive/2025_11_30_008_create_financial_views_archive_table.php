...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('financial_views_archive', function (Blueprint $table) {
            ...
            $table->unique(['franchise_store', 'business_date', 'sub_account', 'area'], 'unique_fin_views_archive');
        });

        // Add monthly partitioning with compression
        $this->addMonthlyPartitions('financial_views_archive');
    }
    ...
    {
        Schema::connection($this->connection)->dropIfExists('financial_views_archive');
    }
};
