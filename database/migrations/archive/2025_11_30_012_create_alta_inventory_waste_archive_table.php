...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('alta_inventory_waste_archive', function (Blueprint $table) {
            ...
            $table->unique(['franchise_store', 'business_date', 'item_id'], 'inv_waste_unique_arch');
        });

        // Add monthly partitioning with compression
        $this->addMonthlyPartitions('alta_inventory_waste_archive');
    }
    ...
    {
        Schema::connection($this->connection)->dropIfExists('alta_inventory_waste_archive');
    }
};
