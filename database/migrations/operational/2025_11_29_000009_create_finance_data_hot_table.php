...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('finance_data_hot', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['franchise_store', 'business_date'], 'unique_finance_data_hot');
        });
    }

    public function down(): void
    {
        Schema::connection($this->connection)->dropIfExists('finance_data_hot');
    }
};
