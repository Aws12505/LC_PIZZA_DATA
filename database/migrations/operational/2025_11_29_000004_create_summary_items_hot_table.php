...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('summary_items_hot', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['franchise_store', 'business_date', 'menu_item_name', 'item_id'], 'unique_summary_items_hot');
        });
    }

    public function down(): void
    {
        Schema::connection($this->connection)->dropIfExists('summary_items_hot');
    }
};
