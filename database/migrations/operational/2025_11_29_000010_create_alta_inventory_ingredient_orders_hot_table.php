...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('alta_inventory_ingredient_orders_hot', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['franchise_store', 'business_date', 'supplier', 'invoice_number', 'purchase_order_number', 'ingredient_id'], 'inv_ing_orders_unique_hot');
        });
    }

    public function down(): void
    {
        Schema::connection($this->connection)->dropIfExists('alta_inventory_ingredient_orders_hot');
    }
};
